...
export interface PlayerStats {
  ...
  opposition_box_touches_per_90_percentile: number | null
  opposition_box_touches_percentile: number | null
  // Possession & progression
  successful_passes_per90: number | null
  successful_passes_per_90_percentile: number | null
  ...
  accurate_long_balls_per_90_percentile: number | null
  ...
  successful_dribbles_per_90_percentile: number | null
  ...
  aerial_duels_won_per_90_percentile: number | null
