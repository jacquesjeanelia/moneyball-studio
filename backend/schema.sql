...
CREATE TABLE IF NOT EXISTS "player_season_stats" (
    ...
    "npxg_per_90_percentile"                          FLOAT,
    "shots_per_90_percentile"                         FLOAT,
    "shots_on_target_per_90_percentile"               FLOAT,
    "headed_shots_per_90_percentile"                  FLOAT,
    "xa_per_90_percentile"                            FLOAT,
    "successful_passes_per_90_percentile"             FLOAT,
    "successful_pass_rate_percentile"                 FLOAT,
    "accurate_long_balls_per_90_percentile"           FLOAT,
    "accurate_long_balls_rate_percentile"             FLOAT,
    "chances_created_per_90_percentile"               FLOAT,
    "big_chances_created_per_90_percentile"           FLOAT,
    "successful_crosses_per_90_percentile"            FLOAT,
    "successful_cross_rate_percentile"                FLOAT,
    "successful_dribbles_per_90_percentile"           FLOAT,
    "successful_dribble_rate_percentile"              FLOAT,
    "duels_won_per_90_percentile"                     FLOAT,
    "duel_success_rate_percentile"                    FLOAT,
    "aerial_duels_won_per_90_percentile"              FLOAT,
    "aerial_duel_success_rate_percentile"             FLOAT,
    "touches_per_90_percentile"                       FLOAT,
    "opposition_box_touches_per_90_percentile"        FLOAT,
    "dispossessed_per_90_percentile"                  FLOAT,
    "fouls_won_per_90_percentile"                     FLOAT,
    "defcon_per_90_percentile"                        FLOAT,
    "tackles_per_90_percentile"                       FLOAT,
    "interceptions_per_90_percentile"                 FLOAT,
    "blocks_per_90_percentile"                        FLOAT,
    "fouls_committed_per_90_percentile"               FLOAT,
    "recoveries_per_90_percentile"                    FLOAT,
    "possession_won_final_third_per_90_percentile"    FLOAT,
    "dribbled_past_per_90_percentile"                 FLOAT,
    "clearances_per_90_percentile"                    FLOAT,
