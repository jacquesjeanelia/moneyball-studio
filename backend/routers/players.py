...
STAT_COLUMNS = (
    "minutes_played",
    # Attacking
    "npxg_per90", "npxg_per_90_percentile", "npxg_percentile",
    "shots_per90", "shots_per_90_percentile", "shots_percentile",
    "shots_on_target_per90", "shots_on_target_per_90_percentile", "shots_on_target_percentile",
    "headed_shots_per90", "headed_shots_per_90_percentile", "headed_shots_percentile",
    "xa_per90", "xa_per_90_percentile", "xa_percentile",
    "chances_created_per90", "chances_created_per_90_percentile", "chances_created_percentile",
    "big_chances_created_per90", "big_chances_created_per_90_percentile", "big_chances_created_percentile",
    "successful_crosses_per90", "successful_crosses_per_90_percentile", "successful_crosses_percentile",
    "successful_cross_rate", "successful_cross_rate_percentile",
    "opposition_box_touches_per90", "opposition_box_touches_per_90_percentile", "opposition_box_touches_percentile",
    # Possession & progression
    "successful_passes_per90", "successful_passes_per_90_percentile", "successful_passes_percentile",
    "successful_pass_rate", "successful_pass_rate_percentile",
    "accurate_long_balls_per90", "accurate_long_balls_per_90_percentile", "accurate_long_balls_percentile",
    "accurate_long_balls_rate", "accurate_long_balls_rate_percentile",
    "successful_dribbles_per90", "successful_dribbles_per_90_percentile", "successful_dribbles_percentile",
    "successful_dribble_rate", "successful_dribble_rate_percentile",
    "touches_per90", "touches_per_90_percentile", "touches_percentile",
    "dispossessed_per90", "dispossessed_per_90_percentile", "dispossessed_percentile",
    "fouls_won_per90", "fouls_won_per_90_percentile", "fouls_won_percentile",
    "duels_won_per90", "duels_won_per_90_percentile", "duels_won_percentile",
    "duel_success_rate", "duel_success_rate_percentile",
    # Defending & physical
    "aerial_duels_won_per90", "aerial_duels_won_per_90_percentile", "aerial_duels_won_percentile",
    "aerial_duel_success_rate", "aerial_duel_success_rate_percentile",
    "tackles_per90", "tackles_per_90_percentile", "tackles_percentile",
    "interceptions_per90", "interceptions_per_90_percentile", "interceptions_percentile",
    "blocks_per90", "blocks_per_90_percentile", "blocks_percentile",
    "clearances_per90", "clearances_per_90_percentile", "clearances_percentile",
    "recoveries_per90", "recoveries_per_90_percentile", "recoveries_percentile",
    "possession_won_final_third_per90", "possession_won_final_third_per_90_percentile", "possession_won_final_third_percentile",
    "dribbled_past_per90", "dribbled_past_per_90_percentile", "dribbled_past_percentile",
    "fouls_committed_per90", "fouls_committed_per_90_percentile", "fouls_committed_percentile",
    "defcon_per90", "defcon_per_90_percentile", "defcon_percentile",
)
